cleaner = ['black', 'jew', 'sex', 'nazi', 'gay', 'homo', 'balls', 'racist', 
        'dick', 'dead babies', 'hookers', 'hitler', 'pussy', 'taliban', 'shit',
        'bitch', 'muslim', 'blow', 'fuck', 'shoot', 
        'slaves', 'slut', 'ISIS', 'finger','terrorist','pedophile']


jokes = ["Why did the chemist go to the emergency room? For his glutamine problem.",
